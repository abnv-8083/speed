...
INSERT INTO products (name, price, stock, is_print) VALUES
  ...
  ('A3 Print (B&W)', 5, 1000, true),
  ('A3 Print (Color)', 20, 500, true),
  ('A5 Print (B&W)', 1, 3000, true),
  ('A5 Print (Color)', 5, 1500, true),
...
CREATE POLICY "Enable all actions for public print_logs" ON print_logs FOR ALL USING (true) WITH CHECK (true);
